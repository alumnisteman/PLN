...
import {
  ...
  Zap, LogOut, User, X,
  Database, Briefcase, Building2, Boxes, Ruler,
} from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Jabatan",          href: "/master?type=positions",           icon: Briefcase,  permission: "master.view" },
      { label: "Departemen",       href: "/master?type=departments",         icon: Building2,   permission: "master.view" },
      { label: "Kategori Material", href: "/master?type=material-categories", icon: Boxes,      permission: "master.view" },
      { label: "Satuan",           href: "/master?type=units",                icon: Ruler,      permission: "master.view" },
    ],
  },
